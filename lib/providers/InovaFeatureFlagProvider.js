...
var InovaFeatureFlagContext = (0, _react.createContext)({});
exports.InovaFeatureFlagContext = InovaFeatureFlagContext;
var InovaFeatureFlagProvider = function InovaFeatureFlagProvider(_ref) {
  ...
  var _useState3 = (0, _react.useState)(null),
    ...
    lastFetchedAt = _useState4[0],
    setLastFetchedAt = _useState4[1];
  var options = (0, _react.useMemo)(function () {
    return userOptions !== null && userOptions !== void 0 ? userOptions : defaultOptions;
  }, [userOptions]);
  var headers = new Headers({
    Authorization: "Bearer ".concat(sdkKey)
  });
  var fetchFeatureFlags = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response, data, newFlags;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", new Error("No SDK key provided"));
          case 2:
            _context.next = 4;
          ...
          case 7:
            data = _context.sent;
            newFlags = new Map();
            data.featureFlags.forEach(function (flag) {
    ...
    return function fetchFeatureFlags() {
      return _ref2.apply(this, arguments);
    };
  }();
  var useInovaFlag = function useInovaFlag(key, defaultValue) {
    var _useState5 = (0, _react.useState)(defaultValue),
      _useState6 = _slicedToArray(_useState5, 2),
      value = _useState6[0],
      setValue = _useState6[1];
    (0, _react.useEffect)(function () {
      var newValue = flags.get(key);
  ...
  return <InovaFeatureFlagContext.Provider value={{
    useInovaFlag: useInovaFlag
  }}>
      {children}
